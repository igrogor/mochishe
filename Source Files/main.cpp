// Структура данных: дек (deque — double ended queue)
//  с ограниченным входом (добавление с одного конца,
//   удаление с двух концов), реализованный
//    на двунаправленном списке.
// Способ хранения объектов: объекты.

// Реализовать с помощью классов динамическую 
// списочную структуру, содержащую объекты
//  классов, связанных наследованием. В классах
//   реализовать методы добавления, удаления,
//    вставки по номеру, удаления по номеру,
//     поиска и просмотра всей структуры.
// Дополнить демонстрационную программу так,
//  чтобы она демонстрировала полиморфическое
//   поведение классов. Исследовать,
